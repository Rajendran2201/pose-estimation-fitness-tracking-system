...
- Define one core research problem (narrow down)
...
- Define the scope (What exercises?, Single-person or Multi-person?, Camera?, Environment (Indoor or outdoor)).
...
- Study about temporal models, and how is it relevant to our project.
- Key tasks: Pose estimation method, Rep counting, Feature engineering, Temporal methods, Feedback systems.

## Phase 1: Data Collection and Preparation 
- Create or gather datasets. (Human3.6M (for 3D poses) or Fitness-specific subsets from YouTube-8M.)
- Study the survey or review papers to identify the potential datasets to work on.
